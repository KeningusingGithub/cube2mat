# features/pre_std_close.py
from __future__ import annotations
import datetime as dt
import pandas as pd
from feature_base import BaseFeature, FeatureContext

class PreStdCloseFeature(BaseFeature):
    """
    盘前 00:00–09:29 内，按 symbol 计算 close 的标准差；若有效点 < 3，则 NaN。
    输出: ['symbol', 'value']。
    """
    name = "pre_std_close"
    description = "Pre-market std(close) between 00:00–09:29; NaN if <3 ticks."
