# features/pre_sum_volume.py
from __future__ import annotations
import datetime as dt
import pandas as pd
from feature_base import BaseFeature, FeatureContext

class PreSumVolumeFeature(BaseFeature):
    """
    盘前 00:00–09:29 内，按 symbol 统计 volume 总和。
    输出: ['symbol', 'value']。
    """
    name = "pre_sum_volume"
    description = "Pre-market sum(volume) 00:00–09:29."
