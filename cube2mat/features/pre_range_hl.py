# features/pre_range_hl.py
from __future__ import annotations
import datetime as dt
import pandas as pd
from feature_base import BaseFeature, FeatureContext

class PreRangeHLFeature(BaseFeature):
    """
    盘前 00:00–09:29 内，按 symbol 计算 max(high) - min(low)。
    输出: ['symbol', 'value']。
    """
    name = "pre_range_hl"
    description = "Pre-market range: max(high) - min(low) between 00:00–09:29."
