...
class PostStdRetFeature(BaseFeature):
    """
    盘后 16:00–23:59 内，按 symbol 计算日内简单收益率 ret=close.pct_change() 的标准差；
    若有效收益率个数 < 3，则 NaN。
    输出: ['symbol', 'value']。
    """
    name = "post_std_ret"
    description = "After-hours std of intraday returns (pct_change of close) 16:00–23:59; NaN if <3 returns."
